...
@Component
public class MessagePublishRejectedExecutionHandler implements RejectedExecutionHandler {

    private Logger logger = LoggerFactory.getLogger(MessagePublishRejectedExecutionHandler.class);
